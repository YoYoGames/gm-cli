...
export const ApiErrorCodes = {
  ...
  breaking_published_game: "game is published and this operation would break requirements for publication",
  ...
  game_bundle_unsupported_charset: "game bundle was encoded with an unsupported charset",
  game_cover_not_found: "cover id not valid or not found for provided gameId",
  game_creation_not_allowed: "only the owner of the group may create a game for the group",
  game_description_empty: "short description needed to publish the public track",
  ...
  invalid_studio_ownership: "the users studio has an invalid amount of owners (not 1)",
  max_games_limit_reached: "the group has reached its max games limit",
  max_graphics_limit_reached: "the game has reached the maximum number of graphics per game limit",
  missing_game_covers: "must have a cover uploaded for all supported aspect ratios",
  ...
  no_platforms_added: "at least one platform needed to publish the public track",
  ...
  page_size_invalid: "invalid pageSize parameter value; must be a valid decimal integer",
  page_size_less_than_1: "invalid pageSize parameter value; must be 1 or higher",
  page_size_too_high: "the page size exceeds the maximum limit",
  preview_required_for_videos: "when uploading videos, a 'preview' image must be included as a thumbnail",
  shared_array_buffer_is_not_supported: "Shared Array buffer support is not provided",
  ...
  template_metadata_required_for_template: "games in the HH Store should have template metadata",
  unsupported_graphic_format: "the image format is not supported or could not be identified",
  upload_custom_game_bundle_not_allowed: "upload custom game bundle not allowed",
